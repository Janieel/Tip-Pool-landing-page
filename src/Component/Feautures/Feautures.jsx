...
const Feautures = () => {
  return (
    <div>
         ...
         <div className=' mt-15 '>
              <p className=' text-center text-[2.5rem] text-white font-extrabold font-serif'>Why Choose Tip-Pool?</p>
              <p className='text-center text-[1.5rem] text-white'>Cutting-Edge Features for Everyone</p>
              <div className="flex items-center w-full gap-5  mt-10 px-20  "> 
                 <ul className=' w-full flex gap-4 overflow-x-scroll '>
                      <li className='  px-5  w-[360px]  rounded-t-[20px] bg-blue-100 pt-5 flex-shrink-0' >
