...
const Wallcon = () => {
  return (
<div>
        <div id='hows' className='mt-20  mx-4 sm:mx-6 lg:mx-10'>
            <p className='text-[2rem] md:text-[2.5rem] lg:text-[3rem] flex items-center justify-center h-15  sm:mb-10 font-bold font-serif text-white'>How It Works</p>
            <div className=' grid grid-cols-1 sm:grid-cols-3 gap-4 text-white  rounded-[20px]    lg:p-10 '>
              <div className='flex flex-col items-center   md:items-center'>
                    ...
                    <p className='  text-[1.5rem]   text-center '>Connect Wallet</p>
